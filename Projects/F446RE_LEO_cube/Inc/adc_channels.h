...
static const uint8_t ANALOG_DEFAULT_INPUTS[MAX_ADC_CHANNELS]={2,2,1}; // !!! ADC1 == CH3, ADC3 == CH1
static const uint8_t ANALOG_VREF_INPUTS[MAX_ADC_CHANNELS]={6,0,0};
...
static const uint16_t ANALOG_PIN_ADC2[ADC2_NUM_CHANNELS] = {			GPIO_PIN_1,			GPIO_PIN_0,			GPIO_PIN_0,			0};
static GPIO_TypeDef * ANALOG_GPIO_ADC2[ADC2_NUM_CHANNELS] = {			GPIOC,				GPIOC,				GPIOA,				0};
static const uint32_t ANALOG_CHANNEL_ADC2[ADC2_NUM_CHANNELS] = {		ADC_CHANNEL_11,		ADC_CHANNEL_10,		ADC_CHANNEL_8,		ADC_CHANNEL_17};
static const char* ANALOG_CHANN_ADC2_NAME[ADC2_NUM_CHANNELS] = { 		"A4", 				"A5", 				"A3", 				"Vref" };

#define ADC3_NUM_CHANNELS 5
static const uint16_t ANALOG_PIN_ADC3[ADC3_NUM_CHANNELS] = {			GPIO_PIN_0,			GPIO_PIN_1,			GPIO_PIN_0,			GPIO_PIN_1,			0};
static GPIO_TypeDef * ANALOG_GPIO_ADC3[ADC3_NUM_CHANNELS] = {			GPIOC,				GPIOC,				GPIOA,				GPIOA,				0};
static const uint32_t ANALOG_CHANNEL_ADC3[ADC3_NUM_CHANNELS] = {		ADC_CHANNEL_10,		ADC_CHANNEL_11,		ADC_CHANNEL_0,		ADC_CHANNEL_1,		ADC_CHANNEL_17};
static const char* ANALOG_CHANN_ADC3_NAME[ADC3_NUM_CHANNELS] = { 		"A5",				"A4", 				"A0",				"A1", 				"Vref" };
